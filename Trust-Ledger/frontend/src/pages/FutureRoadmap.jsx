...
const ROADMAP = [
  ...
  },
  {
    ...
    desc: 'Fixed deposits issued as blockchain tokens — meaning they can be fractionalised, traded, or used as collateral for loans without breaking the deposit. Yield is auto-distributed via smart contracts with full transparency on every payment.',
    benefits: ['Tokenised deposit certificates', 'Use FD as loan collateral', 'Auto yield distribution', 'Fractional ownership support'],
    techStack: 'ERC-1400 tokens · Hyperledger Fabric · DeFi liquidity bridges',
    vision: 'Unlocking trillions in locked fixed deposits by giving customers liquidity without penalties — a paradigm shift in savings products.',
  },
  {
    id: 'corporate_bonds',
    ...
    desc: 'Lloyds Banking Group will issue corporate bonds directly on a permissioned DLT network, enabling instant settlement (T+0), automated coupon payments, and real-time secondary market trading — eliminating traditional clearing house delays entirely.',
    ...
    vision: 'Bringing the £2 trillion UK corporate bond market on-chain — setting a new global standard for capital markets infrastructure.',
  },
];
...
const TIMELINE = [
  ...
  { label: 'Soon', desc: 'Digital Will smart contracts, tokenised Fixed Deposits', color: '#6B46C1', active: false },
